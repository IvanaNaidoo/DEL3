...
MarkLevelID int IDENTITY(1,1) primary key Not null,
Level  int not null	,
Description VARCHAR(200),
Symbol VARCHAR(1))
go
...
LearnerID int IDENTITY(1,1) primary key Not null,
Name VARCHAR(200),
Surname VARCHAR(200),
Email VARCHAR(200),
...
HomeworkID int IDENTITY(1,1) primary key Not null,
...
RoportID int IDENTITY(1,1) primary key,
LearnerID int,
SubjectID int,
UserID int,
MarkLevelID int,
